...
- [/api/movement/factors](movement-factors.md)
- [/api/recognition/areas](recognition-areas.md)
- [/api/recognition/objects](recognition-objects.md)
- [/api/operation/mode/notice](operation-mode-notice.md)
- [/api/operation/mode/change](operation-mode-change.md)
- [/api/pose_initialization/state](pose_initialization-state.md)
- [/api/pose_initialization/reset](pose_initialization-reset.md)
- [/api/pose_initialization/request](pose_initialization-request.md)
